...
{ path : 'searcticket', loadChildren: () => import('./searcticket/searcticket.module').then(m => m.SearcticketModule), canActivate: [AuthGuard] } , 
...
{ path : 'createassignee', loadChildren: () => import('./createassignee/createassignee.module').then(m => m.CreateassigneeModule), canActivate: [AuthGuard] } , 
];
